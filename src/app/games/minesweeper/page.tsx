      ...
      <header className="relative z-10 border-b border-red-500/20 bg-black/60 backdrop-blur-xl">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <Link href="/dashboard" className="flex items-center gap-3">
            ...
            <h1 className="font-[family-name:var(--font-orbitron)] text-lg font-bold bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">
              MINESWEEPER
            </h1>
          </Link>
          <Button variant="outline" onClick={() => router.push("/dashboard")} className="gap-2 border-red-500/30 hover:bg-red-500/10">
